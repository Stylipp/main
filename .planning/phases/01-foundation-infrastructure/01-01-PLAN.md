...
**Apps**: stylipp.com (React PWA), backend (FastAPI)
**Packages**: schemas (Python Pydantic models - API contracts)
**Infrastructure**: Docker Compose, CI/CD configs
**Type flow**: Pydantic schemas → OpenAPI → generated TypeScript
</context>
...
<task type="auto">
  ...
  <action>
    ...
    - packages/ (will contain schemas/ Python package)
...
<task type="auto">
  ...
  <action>
    ...
    This will be extended by apps/stylipp.com/tsconfig.json.
    Backend and packages/schemas are Python (don't use TypeScript).
  </action>
...
- TypeScript base config ready for frontend extension
