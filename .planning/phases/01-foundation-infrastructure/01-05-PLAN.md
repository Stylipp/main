...
files_modified: [apps/backend/src/auth/router/router.py, apps/backend/src/auth/service/service.py, apps/backend/src/auth/schemas/schemas.py, apps/backend/src/auth/utils/jwt.py, apps/backend/src/models/user.py, secrets/jwt/private.pem, secrets/jwt/public.pem, apps/backend/src/dependencies.py]
---
...
<task type="auto">
  ...
  <files>apps/backend/src/auth/utils/jwt.py, apps/backend/src/auth/schemas/schemas.py, apps/backend/src/models/user.py</files>
  <action>
    Create apps/backend/src/auth/utils/jwt.py:
    ...
    Create apps/backend/src/auth/schemas/schemas.py:
  ...
  <done>JWT utility functions created with ES256 algorithm in src/auth/, auth schemas defined, User model created in src/models/</done>
</task>

<task type="auto">
  <name>Task 3: Implement auth router with protected route example</name>
  <files>apps/backend/src/auth/router/router.py, apps/backend/src/auth/service/service.py, apps/backend/src/main.py, apps/backend/src/dependencies.py</files>
  <action>
    Create apps/backend/src/dependencies.py:
    ...
    Create apps/backend/src/auth/service/service.py:
    ...
    Create apps/backend/src/auth/router/router.py:
    ...
    Create empty __init__.py files in src/auth/, src/auth/router/, src/auth/service/, src/auth/schemas/, src/auth/utils/
  </action>
  ...
  <done>Auth router created with protected /me endpoint in src/auth/router/, get_current_user dependency implemented, feature folder structure follows convention</done>
</task>
...
- [ ] Feature folder structure follows convention (src/auth/router/router.py, src/auth/service/service.py)
