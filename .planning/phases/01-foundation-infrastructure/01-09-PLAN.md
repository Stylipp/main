...
type: execute
depends_on: ["01-02"]
files_modified: [apps/web/src/i18n/index.ts, apps/web/src/i18n/locales/en/translation.json, apps/web/src/main.tsx, apps/web/src/components/LanguageExample.tsx]
---
...
<task type="auto">
  ...
  <files>apps/web/package.json, apps/web/src/i18n/index.ts, apps/web/vite.config.ts</files>
  <action>
    Install dependencies:
    `cd apps/web && pnpm add i18next react-i18next i18next-browser-languagedetector`
  ...
  <verify>apps/web/src/i18n/index.ts imports and initializes without errors, i18next configured with English fallback</verify>
...
<task type="auto">
  ...
  <files>apps/web/src/i18n/locales/en/translation.json</files>
  <action>
    Create apps/web/src/i18n/locales/en/translation.json:
    ```json
    {
      "app": {
        "name": "Stylipp",
    ...
    Create directory structure: `mkdir -p apps/web/src/i18n/locales/en`
  </action>
  <verify>apps/web/src/i18n/locales/en/translation.json exists with app, common, navigation, auth, onboarding, errors keys</verify>
...
<task type="auto">
  ...
  <files>apps/web/src/main.tsx, apps/web/src/components/LanguageExample.tsx, apps/web/src/pages/HomePage.tsx</files>
  <action>
    ...
    Create apps/web/src/components/LanguageExample.tsx:
    ...
    Create apps/web/src/i18n/react-i18next.d.ts:
    ```typescript
...
- [ ] apps/web/src/i18n/index.ts initializes i18next
...
- `apps/web/src/i18n/index.ts` - i18next initialization and configuration
- `apps/web/src/i18n/locales/en/translation.json` - English translations
- `apps/web/src/i18n/react-i18next.d.ts` - TypeScript types for autocomplete
- `apps/web/src/components/LanguageExample.tsx` - i18n usage example
- Updated `apps/web/src/main.tsx` - Import i18n and add Suspense
- Updated `apps/web/src/pages/HomePage.tsx` - Use translation keys
